...
class SubSubCategoryController extends Controller
{
    ...
    public function __construct(SubSubCategoryRepositoryInterface $category, CategoryRepositoryInterface $parent_category, SubCategoryRepositoryInterface $subcategory)
    {
    ...
    public function index()
    {
        $data = [
            ...
            'subcategories' => $this->subcategory->categories(),
        ];

        return view('admin.subsubcategory.index')->with(array_merge($this->data, $data));
    }
